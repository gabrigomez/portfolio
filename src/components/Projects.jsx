          ...
          {({ isVisible }) =>
            <div className={isVisible ? "animate__animated animate__zoomIn md:w-3/4" : "none"}>
              <div className='flex justify-center text-primary dark:text-white'>
                <div className='flex flex-col items-center m-2 p-2 pb-10 w-2/4 md:w-64 duration-300 rounded-2xl shadow-md dark:shadow-gray-900 hover:bg-gray-200 dark:hover:bg-secondaryBg group'>
                  <img 
                  ...
                  <a 
                    ...
                    className='flex justify-center'>
                      <GithubLogo className='text-2xl mt-4 opacity-0 group-hover:opacity-100 duration-200 text-center hover:text-black dark:hover:text-primary'/>
                  </a>                     
                </div>
                <div className='flex flex-col items-center m-2 p-2 pb-10 w-2/4 md:w-64 duration-300 rounded-2xl shadow-md dark:shadow-gray-900 hover:bg-gray-200 dark:hover:bg-secondaryBg group'>
                  <img 
